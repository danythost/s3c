...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div class="glass p-8 rounded-3xl relative overflow-hidden group">
        <div class="absolute -right-12 -top-12 w-32 h-32 bg-blue-500/20 rounded-full blur-3xl group-hover:bg-blue-500/30 transition-all"></div>
        <div class="relative">
            <h3 class="text-xl font-bold text-white mb-2">PEYFLEX Wallet</h3>
            <p class="text-sm text-gray-400 mb-6">Active VTU Provider</p>
            
            <div class="flex items-end gap-2 mb-4">
                <span class="text-4xl font-bold text-white">
                    @if(isset($providerBalance))
            ...
            @if(isset($providerBalance) && $providerBalance < 5000)
